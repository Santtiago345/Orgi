...
import { MONTH_NAMES_FULL } from "@/lib/utils";
      ...
      {budgets && budgets.length > 0 ? (
              ...
              <div key={budget.id} className="card-hover p-5 animate-fade-in-up" style={{ animationDelay: `${idx * 60}ms` }}>
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-neutral-500">{MONTH_NAMES_FULL[budget.month - 1]} {budget.year}</p>
                    </div>
                  </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="w-full bg-neutral-100 rounded-full h-2.5 overflow-hidden">
                    <div
                      className={`h-full rounded-full transition-all duration-700 ease-out ${pct > 90 ? "bg-danger" : pct > 70 ? "bg-amber-500" : "bg-success"}`}
        ...
        <div className="card animate-fade-in">
          <div className="empty-state">
            <div className="empty-state-icon"><PiggyBank size={24} className="text-neutral-400" /></div>
