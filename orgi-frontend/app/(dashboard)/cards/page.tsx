      ...
      {isLoading ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="pt-1">
                    <div className="flex justify-between text-xs mb-1.5">
                      ...
                      <span className={`font-semibold ${usage > 80 ? "text-danger" : usage > 50 ? "text-amber-600" : "text-success"}`}>{usage.toFixed(1)}%</span>
                    </div>
                    <div className="w-full bg-neutral-100 rounded-full h-2 overflow-hidden">
                      <div
                        className={`h-full rounded-full transition-all duration-700 ease-out ${usage > 80 ? "bg-danger" : usage > 50 ? "bg-amber-500" : "bg-success"}`}
        ...
        <div className="card animate-fade-in">
          <div className="empty-state">
            <div className="empty-state-icon"><CreditCardIcon size={24} className="text-neutral-400" /></div>
